#!python3
#
# Adapted from epdiy's scripts/fontconvert.py (https://github.com/vroland/epdiy),
# Copyright (c) the epdiy authors, licensed under the GNU LGPL-3.0.
# Modifications for VulnCast: pixel-size CLI arg, curated Unicode intervals, and the
# generated header uses "../epd_compat.h". This file remains under the LGPL-3.0.
#
import freetype
import zlib
import sys
...
intervals = [
    (32, 126), (0xB1, 0xB1), (0xB7, 0xB7), (0x2013, 0x2014), (0x2018, 0x2019), (0x2026, 0x2026),
    # (160, 255),
    # (0x2500, 0x259F),
    # (0x2700, 0x27BF),
    # # powerline symbols
...
print("#pragma once")
print("#include \"../epd_compat.h\"")  # VulnCast: epdiy 2.0 GFXfont/Rect_t typedefs (was epd_driver.h in epdiy 1.x)
